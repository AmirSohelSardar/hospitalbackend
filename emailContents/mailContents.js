...
function succesRegistration(name, email, verificationLink) {
    ...
    <div class="container">
        ...
        <p>Hello ${name},</p>
        <p>Thank you for registering on Lifeline Hospital. To complete your registration, please confirm your email address by clicking the button below:</p>
        <a href="${verificationLink}" class="button">Confirm Email</a>
        <p>If you didn't register on Lifeline Hospital, you can safely ignore this email.</p>
        <p>Thank you,</p>
        <p>Team Lifeline Hospital</p>
    </div>
    </body>
